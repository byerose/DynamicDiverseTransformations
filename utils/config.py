...
class TRANSFORMATION(object):
    ...
    ROTATE = [rotate_30, rotate_60, rotate_90, rotate_180, rotate_270]
    ...
    SHIFT = [shift_left, shift_right, shift_bottom_left]
    ...
    AFFINE = [affine_vertical_compress, affine_vertical_stretch, affine_horizontal_stretch, affine_both_compress, affine_both_stretch]
    ...
    MORPHOLOGY = [morph_erosion, morph_dilation, morph_opening, morph_closing, morph_gradient]
    ...
    NOISES = [noise_gaussian, noise_localvar, noise_poisson, noise_salt, noise_pepper, noise_saltPepper, noise_speckle]
    ...
    FILTERS = [filter_sobel, filter_gaussian, filter_rank, filter_median, filter_maximum]
    ...
    DENOISE = [denoise_tv_chambolle, denoise_tv_bregman, denoise_bilateral, denoise_wavelet]
    ...
    COMPRESSION = [compress_jpeg_quality_80, compress_jpeg_quality_50, compress_jpeg_quality_30, compress_jpeg_quality_10]
   
    """
    adjustment
    """
    adjust_gamma = 'adjust_gamma'
    adjust_equalize_hist = 'adjust_equalize_hist'
    adjust_log = 'adjust_log'
    adjust_brightness = 'adjust_brightness'
    adjust_sharpness = 'adjust_sharpness'
    adjust_contrast = 'adjustment_contrast'
    adjust_average_blur = 'adjust_average_blur'
    adjust_gaussian_blur = 'adjust_gaussian_blur'
    adjust_motion_blur = 'adjust_motion_blur'
    ADJUSTMENT = [adjust_gamma, adjust_brightness, adjust_sharpness, adjust_contrast, adjust_average_blur, adjust_gaussian_blur]
    ...
    geo_jigsaw = 'geo_jigsaw' 
    GEOMETRIC = [geo_swirl, geo_scale, geo_perspective, geo_piecewise]
